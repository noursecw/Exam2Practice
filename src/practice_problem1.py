...
class Box(object):
    ...
    def reset(self):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        self.hist += [self.contents]
        self.volume = self.vi
        self.contents = self.ci
    ...
    def steal(self, other_box):
        ...
        notfit = self.append_string(other_box.contents)
        other_box.contents = notfit
